...
@section('title',  trans('lang.data_collection_main_heading')  )
@section('css')
...
@section('breadcrumb-title')
    <h3>{{ trans('lang.data_collection_main_heading') }}</h3>
@endsection
@section('breadcrumb-items')
    <li class="breadcrumb-item active">{{ trans('lang.data_collection_main_heading') }}</li>
@endsection
@section('content')
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header project-list">
                        <h5>{{ trans('lang.data_collection_main_heading') }}</h5>
                        <span>{{ trans('lang.data_collection_main_heading') }}</span>
                    </div>
                    <div class="card-body">
                                ...
                                @if (isset($data['get_dc_table']) && $data['get_dc_table'] != '')
                                    @foreach ($data['get_dc_table'] as $k=>$r)
                                        ...
                                        <tr>
                                            ...
                                            <td width="9%"><a href="{{route('randomized_detail').'/'.$cluster_no}}" target="_blank" >{{isset($r['hh_randomized']) && $r['hh_randomized']!=''?$r['hh_randomized']:'0'}}</a></td>
                                            <td width="9%"><a href="{{route('data_collection_statusdetail').'/t/'.$cluster_no}}" target="_blank" >{{isset($r['hh_collected']) && $r['hh_collected']!=''?$r['hh_collected']:'0'}}</a></td>
                                            <td width="9%"><a href="{{route('data_collection_statusdetail').'/c/'.$cluster_no}}" target="_blank" >{{isset($r['completed_forms']) && $r['completed_forms']!=''?$r['completed_forms']:'0'}}</a></td>
                                            <td width="9%"><a href="{{route('data_collection_statusdetail').'/r/'.$cluster_no}}" target="_blank" >{{isset($r['refused_forms']) && $r['refused_forms']!=''?$r['refused_forms']:'0'}}</a></td>
                                            <td width="9%"><a href="{{route('data_collection_statusdetail').'/n/'.$cluster_no}}" target="_blank" >{{isset($r['not_elig']) && $r['not_elig']!=''?$r['not_elig']:'0'}}</a></td>
                                            <td width="9%"><a href="{{route('data_collection_statusdetail').'/o/'.$cluster_no}}" target="_blank" >{{isset($r['remaining_forms']) && $r['remaining_forms']!=''?$r['remaining_forms']:'0'}}</a></td>
                                            <td width="9%">
                                                @php
                                                    $status = '';
